 ...
 *   https://datatables.net/download/#bs5-5.3.0/dt-2.1.4/date-1.5.3/fc-5.0.1/fh-4.0.1/r-3.0.2/sb-1.8.0
 *
 * Included libraries:
 *   Bootstrap 5 5.3.0, DataTables 2.1.4, DateTime 1.5.3, FixedColumns 5.0.1, FixedHeader 4.0.1, Responsive 3.0.2, SearchBuilder 1.8.0
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5-5.3.0/dt-2.1.4/date-1.5.3/fc-5.0.1/fh-4.0.1/r-3.0.2/sb-1.8.0",

...
class Pinjam_model extends CI_model{
    ...
    public function check_jadwal_bentrok($tanggal, $jam_mulai, $jam_selesai, $nama_lab, $id = null) {
        // Tambahkan kondisi where untuk mengecualikan peminjaman yang sedang diedit
        ...
        // Kecualikan peminjaman dengan ID yang sedang diedit
        if ($id !== null) {
            $this->db->where('id !=', $id);
        }
